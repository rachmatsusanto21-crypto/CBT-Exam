...
export const SchoolProfileAndPrintView: React.FC<SchoolProfileAndPrintViewProps> = ({
  ...
  const handlePrintExam = () => {
    printExamToDocsFormat(activeExam, profile, { includeAnswerKey });
  };
  ...
  return (
    <div id="school-profile-and-print-view" className="space-y-6">
      ...
      <div className="bg-[#121214] rounded-2xl p-6 border border-slate-800 shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Atur identitas lembaga, logo kop sekolah, dan cetak naskah soal berstandar dokumen resmi.
          </p>
        </div>
      ...
      <div className="bg-[#121214] rounded-2xl p-6 border border-slate-800 shadow-sm space-y-4">
        <div className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-slate-300">
            ...
            <span>Preview Kop Surat Resmi Sekolah</span>
          </span>
          <span className="text-[11px] text-indigo-400 font-medium">Tersinkronisasi Otomatis pada Slide & Dokumen</span>
        </div>

        {/* Formatted Kop Surat (Keep white/light inner sheet for realistic print preview) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Right: Teacher & Principal Information & Print Config */}
